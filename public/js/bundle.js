      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alert.showAlert)('error', 'Login failed. Please check your credentials.');
          }
          _context.next = 10;
          break;
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error logging in. Please try again later.');
        case 10:
        case "end":
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alert.showAlert)('error', 'Signup failed. Enter valid details');
          }
          _context3.next = 10;
          break;
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error signing up. Please try again later.');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.next = 4;
          return _axios.default.post('/api/v1/users/forgotPassword', {
            email: email
          });
        case 4:
          res = _context4.sent;
...
exports.stripePromise = exports.orderPainting = exports.orderCustomPainting = void 0;
var _axios = _interopRequireDefault(require("axios"));
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripePromise = exports.stripePromise = (0, _stripeJs.loadStripe)('pk_test_51PMEXRD2Om8kn3t3EkJEloAOE7FzcerzplbAfV8s1Y3JB0bOf0kdZLBkjrtjQEIXBd3Mf3SB7kJTqsvrBWzfY8Tk00VMLprYCe');
var orderPainting = exports.orderPainting = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(paintingId) {
    var response, session, stripe, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("http://127.0.0.1:3000/api/v1/orders/checkout-session/".concat(paintingId));
        case 3:
          response = _context.sent;
          session = response.data.session; // Ensure stripePromise is initialized correctly
          _context.next = 7;
          return stripePromise;
        case 7:
  ...
  return function orderPainting(_x) {
    return _ref.apply(this, arguments);
  };
}();
var orderCustomPainting = exports.orderCustomPainting = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(customPaintId) {
    var response, session, stripe, _yield$stripe$redirec, error;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.get("http://127.0.0.1:3000/api/v1/custom-orders/checkout-session-shoe/".concat(customPaintId));
        case 3:
        ...
        case 13:
          _yield$stripe$redirec = _context2.sent;
        ...
        case 18:
          _context2.prev = 18;
          _context2.t0 = _context2["catch"](0);
          console.error('Request Error:', _context2.t0.response ? _context2.t0.response.data : _context2.t0.message);
          alert('There was an error processing your request. Please try again.');
        case 22:
        case "end":
          return _context2.stop();
  ...
  return function orderCustomPainting(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var orderBtn = document.getElementById('order-painting');
  var customOrderBtn = document.getElementById('order-custom-painting');
  ...
  if (resetPasswordForm) {
    resetPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        var password, confirmPassword, token, url, response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
  ...
  var sendPasswordResetEmail = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(user, resetURL) {
      var message;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
    ...
    return function sendPasswordResetEmail(_x2, _x3) {
      return _ref2.apply(this, arguments);
    };
  }();
  if (loginForm) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              confirmPassword = document.getElementById('confirmPassword').value;
              _context4.next = 7;
              return (0, _login.signUp)(name, email, password, confirmPassword);
            case 7:
            case "end":
              return _context4.stop();
          }
  ...
  if (orderBtn) {
    orderBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              paintingId = e.target.dataset.paintingId;
              _context6.prev = 3;
              _context6.next = 6;
              return (0, _stripe.orderPainting)(paintingId);
            case 6:
              _context6.next = 11;
              break;
            case 8:
              ...
              console.error('Order Painting Error:', _context6.t0);
            case 11:
  ...
  if (customOrderBtn) {
    customOrderBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              e.preventDefault();
              e.target.textContent = 'Processing...';
              customPaintId = e.target.dataset.customPaintingId;
              _context7.prev = 3;
              _context7.next = 6;
              return (0, _stripe.orderCustomPainting)(customPaintId);
            case 6:
              _context7.next = 11;
              break;
            case 8:
              ...
              console.error('Order Custom Painting Error:', _context7.t0);
            case 11:
